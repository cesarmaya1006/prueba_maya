...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="{{ asset('imagenes/sistema/mayo-icono.ico') }}" sizes="64x64">
...
<body>
    <div class="row bg-dark d-flex justify-content-center pr-5 pl-5">
        <div class="col-12 pr-5 pl-5">
            <nav class="navbar bg-dark border-bottom border-body navbar-expand-lg bg-body-tertiary pr-5 pl-5" data-bs-theme="dark">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{route('extranet.index')}}">
                        <img src="{{ asset('imagenes/sistema/logoWhite.png') }}" alt="Bootstrap" width="30" height="24">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('login') }}" class="inline-block px-5 py-1.5 text-[#1b1b18] border border-transparent hover:border-[#19140035] rounded-sm text-sm leading-normal" style="color: white;text-decoration: none;">
                                    Log in
                                </a>
                            </li>
                        </ul>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-grid gap-2">
                            <button class="btn btn-outline-warning" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                <img src="{{ asset('imagenes/index/slider0.jpg') }}" class="img-fluid w-100"alt="...">
                            </button>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form class="modal-content form-horizontal" id="form_cliente" action="{{ route('cliente.store') }}" method="POST" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 form-group" id="caja_nombre">
                            ...
                            <input type="text" class="form-control form-control-sm txtOnly"  name="nombre" id="nombre" required>
                        </div>
                        <div class="col-12 col-md-6 form-group" id="caja_apellido">
                            <label class="requerido" for="apellido">Apellidos</label>
                            <input type="text" class="form-control form-control-sm txtOnly"  name="apellido" id="apellido" required>
                        </div>
                        <div class="col-12 col-md-6 form-group" id="caja_identificacion">
                            <label class="requerido" for="identificacion">Cédula</label>
                            <input type="text" class="form-control form-control-sm input-number"  name="identificacion" id="identificacion" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-6 form-group">
                            <label class="requerido" for="departamento_id">Departamento</label>
                            <select id="departamento_id" class="form-control form-control-sm" data_url="{{route('departamento.getMunicipios')}}" required>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 form-group" id="caja_celular">
                            ...
                            <input type="text" class="form-control form-control-sm input-number"  name="celular" id="celular" required>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 form-group">
                            <div class="form-check" style="font-size: 0.7em;font-weight: bold">
                                <input class="form-check-input" type="checkbox" value="1" id="habeas" name="habeas" required>
                                <label class="form-check-label" for="habeas">Autorizo el tratamiento de mis datos de acuerdo con la finalidad establecida en la política de protección de datos personales</label>
                            </div>
                        </div>
                    </div>
                </div>
